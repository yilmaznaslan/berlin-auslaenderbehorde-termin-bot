...
class Section2ServiceSelectionHandlerTest extends BaseTestSetup {
    ...
    static String pathToFile_en_successful = Section2ServiceSelectionHandler.class.getClassLoader().getResource("Section3DateSelectionHandler_2023-03-27_11:09:38_handleTimeSelection.html").getPath();
