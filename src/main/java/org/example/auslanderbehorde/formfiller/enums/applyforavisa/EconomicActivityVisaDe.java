...
import org.example.auslanderbehorde.formfiller.intercaces.VisaApply;

public enum EconomicActivityVisaDe implements VisaApply {
    ...
    JOB_SEEKING_QUALIFIED("SERVICEWAHL_DE163-0-1-1-324661", "Residence permit for job-seeking qualified skilled workers – Issuance (sect. 20)"),
    JOB_SEEKING_ACADEMIC("SERVICEWAHL_DE163-0-1-1-329328", "Residence permit for qualified skilled workers with an academic education (sect. 18b para. 1)"),
    VOCATIONAL_TRAINING("SERVICEWAHL_DE163-0-1-1-305304", "Residence permit for qualified skilled workers with vocational training (sect. 18a)");
